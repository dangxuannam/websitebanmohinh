...
const Dashboard = () => {
    ...
    // radar chart
    let mohinh_doraemon = 0;
    let mohinh_songoku = 0;
    let mohinh_fairytail = 0;
    let mohinh_cupT1vodich = 0;
    let mohinh_cupMUvodich = 0;
    let mohinh_naruto = 0;
    let mohinh_gundam = 0;
    let mohinh_ronaldo = 0;
    let mohinh_messi = 0;
    let mohinh_onepiece = 0;
    let mohinh_POKEMON = 0;
    let mohinh_myheroacademy = 0;
    products &&
        products.forEach((product) => {
            if (product.category === "Mô Hình Doraemon") {
                mohinh_doraemon += 1;
            }
            if (product.category === "Mô Hình Songoku") {
                mohinh_songoku += 1;
            }
            if (product.category === "Mô Hình Fairy Tail") {
                mohinh_fairytail += 1;
            }
            if (product.category === "Mô Hình Cúp T1 Vô Địch") {
                mohinh_cupT1vodich += 1;
            }
            if (product.category === "Mô Hình Cúp MU vô địch") {
                mohinh_cupMUvodich += 1;
            }
            if (product.category === "Mô Hình Naruto") {
                mohinh_naruto += 1;
            }
            if (product.category === "Mô Hình Gundam") {
                mohinh_gundam += 1;
            }
            if (product.category === "Mô Hình Ronaldo") {
                mohinh_ronaldo += 1;
            }
            if (product.category === "Mô Hình Messi") {
                mohinh_messi += 1;
            }
            if (product.category === "Mô Hình One Piece") {
                mohinh_onepiece += 1;
            }
            if (product.category === "Mô Hình POKEMON") {
                mohinh_POKEMON += 1;
            }
            if (product.category === "Mô Hình My Hero Academy") {
                mohinh_myheroacademy += 1;
            }
        });
    const data = {
        labels: [
        ...
        'Mô hình Ronaldo',
        "Mô Hình Messi",
        'Mô hình Cúp T1 Vô Địch',
        'Mô hình Cúp MU Vô Địch',
        'Fairy Tail',
        'POKEMON',
        'My Hero Academy'
        ],
        datasets: [{
            ...
            data: [mohinh_doraemon,mohinh_songoku,mohinh_fairytail,mohinh_cupT1vodich,mohinh_cupMUvodich,mohinh_naruto,mohinh_gundam,mohinh_ronaldo,mohinh_messi,mohinh_onepiece,mohinh_POKEMON,mohinh_myheroacademy],
            fill: true,
